    ...
    \csection{EXPERIENCE}{\small
        \begin{itemize}
            \item \frcontent{HSE University}{Intern-researcher @ LAMBDA}{-- Deep learning applications for online filtering and reconstruction of aerogel detectors;\newline 
                ...
                ``Machine Learning for FARICH Reconstruction at NICA SPD'' accepted in MSU Physics Bulletin (2024)}{November 2021 onwards}
...
% right side %
{
    \csection{SKILLS}{\small
        \begin{itemize}
            ...
            {\footnotesize Docker, WandB, Hydra, GitHub Actions, QuickCheck, GDB, Arch Linux, Shell}
        \end{itemize}
    }
