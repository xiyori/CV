...
% left side %
{
    ...
    \csection{ОБРАЗОВАНИЕ}{\small
        \begin{itemize}
            ...
            \item \frcontent{Единый трек магистратура-аспирантура}{ВШЭ}{}{Студент}
...
% right side %
{
	...
	\csection{НАГРАДЫ}{\small
		\begin{itemize}
            \item \frcontent{Стипендия Яндекса (им. Ильи Сегаловича)}{ВШЭ}{Лауреат}{2022}
			...
			\item \frcontent{Олимпиада Физтех, математика, физика}{МФТИ}{Победитель}{2019}
		\end{itemize}
	}
    ...
    \csection{ХОББИ, ИНТЕРЕСЫ}{\small
        ...
        \begin{tabularx}{\linewidth}{@{}*{4}{>{\centering\arraybackslash}X}@{}}
            ...
            {\footnotesize Анимация} & {\footnotesize Музыка} & {\footnotesize Кастомные клавиатуры} & {\footnotesize Горные лыжи}
        \end{tabularx}
    }
}
\end{tabularx}
